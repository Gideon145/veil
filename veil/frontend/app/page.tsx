  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <section className="px-6 pt-20 pb-16 max-w-6xl mx-auto">
        ...
        {/* ── BUILT BY — always visible ── */}
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 py-6 border-t border-gray-800/40">
          <span className="text-xs text-gray-600 font-mono uppercase tracking-widest">Built by</span>
          <a
          ...
          >
            <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" className="text-gray-600 group-hover:text-white transition-colors duration-200">
            ...
            <span className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors duration-200 tracking-tight">
              Gideon145
            </span>
          </a>
          <span className="hidden sm:block text-gray-700">·</span>
          <span className="text-xs text-gray-600 font-mono">iExec Vibe Coding Challenge 2026</span>
        </div>
      </section>
